...
public class OpenAiController {
    ...
    @GetMapping("/ai/ask/capital/format/{stateOrCountry}")
    public Answer askQuestionWithFormat(@PathVariable String stateOrCountry) {
        return openAiService.getAnswerWithFormat(new GetCapitalRequest(stateOrCountry));
    }
