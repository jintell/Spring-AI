 ...
 */
@SpringBootTest
public class GivingModelTimeToThinkTest extends BaseTestClass {
    String story = """
    ...
    String prompt = """
            ...
            2 - Translate the summary into Yoruba.
            3 - List each name in the Yoruba summary.
            4 - Output a json object that contains the following
            keys: yoruba_summary, num_names.
